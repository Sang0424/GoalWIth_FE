    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.section}>
          ...
          <View style={styles.inputContainer}>
            ...
            <View style={styles.radioGroup}>
              <TouchableOpacity 
                style={[styles.radioButton, isPublic && styles.radioButtonActive]}
              ...
              >
                ...
                <Text style={styles.radioDescription}>누구나 팀을 찾아 가입할 수 있어요</Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text style={styles.radioDescription}>초대를 통해서만 가입할 수 있어요</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
        ...
        <View style={styles.tipBox}>
          <Ionicons name="bulb-outline" size={20} color="#FFA000" style={styles.tipIcon} />
          <View>
            <Text style={styles.tipTitle}>팀 생성 팁</Text>
            <Text style={styles.tipText}>
              • 구체적인 목표를 가진 팀을 만들어보세요
              {'\n'}• 팀 이름은 간결하고 명확하게 지어주세요
              {'\n'}• 팀 설명을 상세히 작성하면 더 많은 사람들이 참여할 수 있어요
            </Text>
          </View>
        </View>
      </ScrollView>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity 
          style={[styles.button, styles.createButton, !teamName && styles.disabledButton]}
